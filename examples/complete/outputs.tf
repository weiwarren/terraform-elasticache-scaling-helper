...
output "aws_sns_topic" {
  value = module.elasticache_scaling_helper.aws_sns_topic
}

output "aws_sqs_queue" {
  value = module.elasticache_scaling_helper.aws_sqs_queue
}

output "cloudwatch_alarm_up" {
  value = module.elasticache_scaling_helper.aws_cloudwatch_alarm_up
}

output "cloudwatch_alarm_down" {
  value = module.elasticache_scaling_helper.aws_cloudwatch_alarm_down
}
